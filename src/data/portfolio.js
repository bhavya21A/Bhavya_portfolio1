...
// PORTFOLIO DATA
// ======================================================
// This file controls most portfolio content.
//
// Update here:
...
// SKILLS
//
// Add technologies inside the appropriate category.
// Example:
...
//
// Example:
// image: "/projects/creovis-homepage.png"
// ======================================================
export const projects = [
  {
    ...
    architecture:
      "React.js UI -> custom backend -> database integration -> admin CRUD modules -> live hosting",

    impact:
      "Built the technical foundation for a real business website and ongoing operational updates.",
...

  {
    ...
    architecture:
      "React.js views -> profile modules -> study groups -> messaging surface -> location-based collaboration",

    impact:
      "Designed around real campus workflows for finding peers, joining groups, and collaborating faster.",
...

  {
    ...
    architecture:
      "Voter flow -> secure ballot process -> blockchain-backed record concept -> transparent result trail",

    impact:
      "Explores trust, auditability, and correctness in secure digital voting workflows.",
...

  {
    ...
    // PROJECT SCREENSHOT
    // image: "/projects/iot-monitoring.png",
    ...
    architecture:
      "Power event signal -> IoT monitoring layer -> website notification -> remote status tracking",

    impact:
      "Connects hardware events to fast software visibility for operational response.",
...
// EXPERIENCE
//
// Add internships, leadership roles,
// startup work, freelance work, etc.
// ======================================================
...
export const education = {
  degree:
    "Bachelor of Technology (B.Tech) in Computer Science with Specialization in IoT",
...
// ACHIEVEMENTS
//
// Add hackathons, competition wins,
